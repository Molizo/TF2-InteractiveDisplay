    ...
    public partial class VehicleDisplayWindow : Window
    {
        ...
        private void UpdateUI()
        {
            ...
            if (monitoredVehicle.state == "AT_TERMINAL")
            {
                ...
                NextStopGrid.Background = (Brush)bc.ConvertFrom("#FFFF0000");
                NextStopLabel.Foreground = (Brush)bc.ConvertFrom("#FFFFFFFF");
            }
            else
            {
                NextStopLabel.Content = "Next up " + NextStopLabel.Content;
                NextStopGrid.Background = (Brush)bc.ConvertFrom("#FFD4D4D4");
                NextStopLabel.Foreground = (Brush)bc.ConvertFrom("#FF000000");
            }
